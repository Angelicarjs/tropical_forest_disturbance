...
#SBATCH --output=classification_models/results/results_0/eval_%j.log
...
mkdir -p classification_models/results/results_0   # so slurm can write the log there
...
python classification_models/code/run_eval.py \
    --results-root classification_models/results/results_0 \
