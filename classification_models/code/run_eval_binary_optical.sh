...
#SBATCH --output=classification_models/results/results_binary_optical/eval_%j.log
...
mkdir -p classification_models/results/results_binary_optical   # so slurm can write the log there
...
python classification_models/code/run_eval_binary.py \
    ...
    --results-root classification_models/results/results_binary_optical \
