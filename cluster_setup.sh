...
echo "  nohup python ~/thesis_scripts/tile_pipeline.py --workers 6 --resume > ~/thesis_scripts/pipeline_output.log 2>&1 &"
echo ""
echo "To monitor:"
echo "  tail -f ~/thesis_scripts/pipeline_output.log"
